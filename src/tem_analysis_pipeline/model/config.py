...
for organelle, params in config.items():
    params['window_shape'] = (
        compute_output_size(input_size=params['tile_shape'][0], layer_depth=params['layer_depth']),
        compute_output_size(input_size=params['tile_shape'][1], layer_depth=params['layer_depth']))
